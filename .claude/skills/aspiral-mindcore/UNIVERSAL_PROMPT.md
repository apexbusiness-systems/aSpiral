...
#
# OpenAI / GPT-4 / GPT-4o:
#   messages = [{"role": "system", "content": "<paste prompt here>"}, ...]
#
# Anthropic / Claude:
#   system = "<paste prompt here>"
#
# Google Gemini (API):
#   system_instruction = "<paste prompt here>"
#
# Meta Llama (llama.cpp / Ollama / Together AI):
#   [INST] <<SYS>>\n<paste prompt here>\n<</SYS>>\n[/INST]
#
# Mistral / Mixtral:
#   messages = [{"role": "system", "content": "<paste prompt here>"}, ...]
#
# Cohere Command R:
#   preamble = "<paste prompt here>"
#
# Any other model:
#   Place before the first user turn as the system or instruction context.
#   No tools, no function calls, no special tokens required.
#
# TEMPERATURE RECOMMENDATION: 0.5–0.7 (warmth without drift)
