...
export function runPhysicsIteration(
  ...
  // Performance Optimization: Consolidated multiple sequential entity iterations into a single loop
  // to avoid redundant Map lookups and intermediate array allocations on the hot path.
  for (let i = 0; i < entities.length; i++) {
